...
module design_1
  ...
  design_1_poartaOR_0_0 poartaOR_0
       (.a(a_0_1),
        .b(b_0_1),
        .c(poartaOR_0_c));
  design_1_poartaOR_1_0 poartaOR_1
       (.a(registruTampon_0_iesire),
        .b(registruTampon_1_iesire));
  design_1_poartaOR_2_0 poartaOR_2
       (.a(registruTampon_3_iesire),
        .b(registruTampon_2_iesire),
        .c(poartaOR_2_c));
  design_1_registruTampon_0_0 registruTampon_0
       (.clk(clk_0_1),
        .enable(enable_0_1),
        .iesire(registruTampon_0_iesire),
        .intrare(poartaOR_0_c),
        .reset(reset_0_1));
  design_1_registruTampon_1_0 registruTampon_1
       (.clk(clk_0_1),
        .enable(enable_0_1),
        .iesire(registruTampon_1_iesire),
        .intrare(intrare_0_1),
        .reset(reset_0_1));
  design_1_registruTampon_2_0 registruTampon_2
       (.clk(clk_0_1),
        .enable(enable_0_1),
        .iesire(registruTampon_2_iesire),
        .intrare(1'b0),
        .reset(reset_0_1));
  design_1_registruTampon_3_0 registruTampon_3
       (.clk(clk_0_1),
        .enable(enable_0_1),
        .iesire(registruTampon_3_iesire),
        .intrare(registruTampon_0_iesire),
        .reset(reset_0_1));
  design_1_registruTampon_4_0 registruTampon_4
       (.clk(clk_0_1),
        .enable(enable_0_1),
        .iesire(registruTampon_4_iesire),
        .intrare(poartaOR_2_c),
        .reset(reset_0_1));
endmodule
